    ...
    <div>
      {page === "home" && (
        <div className="w-full  overflow-x-hidden min-h-[1300px] xl:min-h-[700px] m-auto xl:m-0 xl:pt-12 xl:pr-[140px] xl:pb-12 xl:pl-[140px] overflow-hidden">
          <div className="relative mx-auto xl:mt-29 xl:mb-20 flex flex-col gap-[30px] xl:w-[1160px]   w-[335px] h-[1290px] xl:h-[435px] overflow-hidden">
            <div className="flex flex-col items-center justify-center xl:gap-3 gap-3">
              ...
              <div className="text-center xl:w-[472px] w-[335px] h-[76px] xl:h-[44px] font-montserrat font-bold xl:text-[32px] text-[24px] xl:leading-[44px] text-[#000018]">
                Why Choose{" "}
                <span className="text-[rgba(100,73,255,1)]"> GSE </span>{" "}
                Solutions?
              </div>
      ...
      {page === "services" && (
        <div className="w-full relative overflow-x-hidden min-h-[1300px] xl:min-h-[700px] m-auto xl:m-0 xl:pt-12 xl:pr-[140px] xl:pb-12 xl:pl-[140px] overflow-hidden">
          <div className=" absolute inset-0  w-full h-full bg-[linear-gradient(180deg,#F9F8FF_0%,#FFFFFF_93.53%)] "></div>
      ...
      {page === "about" && (
        <div className="w-full relative overflow-x-hidden min-h-[1300px] xl:min-h-[700px] m-auto xl:m-0 xl:pt-20 xl:pr-[140px] xl:pb-12 xl:pl-[140px] overflow-hidden">
          <div className=" absolute inset-0  w-full h-full bg-[linear-gradient(180deg,#F9F8FF_0%,#FFFFFF_93.53%)]  xl:mt-15 "></div>
          <div className="relative mx-auto xl:mt-20 mt-5  flex flex-col gap-[30px] xl:w-[1160px]   w-[335px] h-[1290px] xl:h-[435px] overflow-hidden">
            <div className="flex flex-col items-center justify-center xl:gap-3 gap-3">
              <div className="xl:w-[157px] xl:h-[22px] w-[139px] h-[18px] font-commissioner font-medium xl:text-[14px] text-[12px] text-center uppercase text-[#F545A6]">
                OUR CORE VALUES
              </div>
